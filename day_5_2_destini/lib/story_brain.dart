...
class StoryBrain {
  ...
  // I had already done step 25 before I saw it. Oops
  int _storyNumber = 0;
  ...
  void nextStory(int choiceNumber){
    ...
    //TODO: Step 21 (DONE) - Using the story plan, update nextStory() to change the storyNumber depending on the choice made by the user. e.g. if choiceNumber was equal to 1 and the storyNumber is 0, the storyNumber should become 2.
  ...
  //TODO: Step 27 (DONE) - Create a method called buttonShouldBeVisible() which checks to see if storyNumber is 0 or 1 or 2 (when both buttons should show choices) and return true if that is the case, else it should return false.
